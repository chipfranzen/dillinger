...
class RewardGenerator:
    def __init__(self, min_price, max_price, n_price_points, seed=None):
    ...
    def pull_arm(self, arm_index):
        ...
        inputs:
        arm_index (int): index of the arm to be pulled
    ...
    def sample(self, n_draws):
        # draws random samples from the reward generator
        # by pulling arms uniformly
